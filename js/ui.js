const UI = {
  generarTarjetaPlato(item, rol, currentSelection = []) {
    ...
    // ==========================================
    // ESTRUCTURA 1: PC (CÓDIGO ORIGINAL INTOCABLE)
    // ==========================================
    const pcCard = `
    ...
    // ==========================================
    // ESTRUCTURA 2: CELULAR (DISEÑO VERTICAL)
    // ==========================================
    const mobileCard = `
      <div class="flex sm:hidden flex-col w-full h-full bg-[#121212] rounded-lg border ${rol === 'admin' && isPausado ? 'border-primary/40 opacity-60 grayscale-[40%]' : 'border-primary-container/20'} overflow-hidden relative glow-hover transition-all duration-300">
        <div class="h-48 relative bg-surface-container-highest flex items-center justify-center overflow-hidden shrink-0">
